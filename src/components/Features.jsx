...
const Features = () => {
  return (
    <section id="nosotros" className={styles.features}>
      <div className="container">
        ...
        <div className={styles.featureItem}>
          ...
          <div className={styles.featureImage} style={{ overflow: 'hidden' }}>
            <img src="/card_1.jpg" alt="Experiencia Automotriz" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
        </div>

        <div className={styles.featureItem} style={{ flexDirection: 'row-reverse' }}>
          <div className={styles.featureText}>
